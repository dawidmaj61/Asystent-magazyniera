...
public class regal220 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_regal220);
        ...
        switch_button.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor.putString("checked34b","yes34b");
                    prefEditor.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor.putString("checked34b","false34b");
                    prefEditor.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button2.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor2.putString("checked35b","yes35b");
                    prefEditor2.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView2.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor2.putString("checked35b","false35b");
                    prefEditor2.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button3.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor3.putString("checked36b","yes36b");
                    prefEditor3.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView3.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor3.putString("checked36b","false36b");
                    prefEditor3.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button4.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor4.putString("checked37b","yes37b");
                    prefEditor4.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView4.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor4.putString("checked37b","false37b");
                    prefEditor4.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button5.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor5.putString("checked38b","yes38b");
                    prefEditor5.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView5.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor5.putString("checked38b","false38b");
                    prefEditor5.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button6.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor6.putString("checked39b","yes39b");
                    prefEditor6.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView6.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor6.putString("checked39b","false39b");
                    prefEditor6.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button7.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor7.putString("checked40b","yes40b");
                    prefEditor7.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView7.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor7.putString("checked40b","false40b");
                    prefEditor7.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button8.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor8.putString("checked41b","yes41b");
                    prefEditor8.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView8.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor8.putString("checked41b","false41b");
                    prefEditor8.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button9.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor9.putString("checked42b","yes42b");
                    prefEditor9.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView9.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor9.putString("checked42b","false42b");
                    prefEditor9.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button10.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor10.putString("checked43b","yes43b");
                    prefEditor10.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView10.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor10.putString("checked43b","false43b");
                    prefEditor10.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button11.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor11.putString("checked44b","yes44b");
                    prefEditor11.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView11.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor11.putString("checked44b","false44b");
                    prefEditor11.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button12.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor12.putString("checked45b","yes45b");
                    prefEditor12.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView12.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor12.putString("checked45b","false45b");
                    prefEditor12.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button13.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor13.putString("checked46b","yes46b");
                    prefEditor13.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView13.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor13.putString("checked46b","false46b");
                    prefEditor13.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button14.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor14.putString("checked47b","yes47b");
                    prefEditor14.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView14.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor14.putString("checked47b","false47b");
                    prefEditor14.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button15.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor15.putString("checked48b","yes48b");
                    prefEditor15.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView15.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor15.putString("checked48b","false48b");
                    prefEditor15.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button16.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor16.putString("checked49b","yes49b");
                    prefEditor16.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView16.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor16.putString("checked49b","false49b");
                    prefEditor16.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button17.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor17.putString("checked50b","yes50b");
                    prefEditor17.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView17.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor17.putString("checked50b","false50b");
                    prefEditor17.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button18.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor18.putString("checked51b","yes51b");
                    prefEditor18.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView18.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor18.putString("checked51b","false51b");
                    prefEditor18.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button19.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor19.putString("checked52b","yes52b");
                    prefEditor19.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView19.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor19.putString("checked52b","false52b");
                    prefEditor19.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button20.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor20.putString("checked53b","yes53b");
                    prefEditor20.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView20.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor20.putString("checked53b","false53b");
                    prefEditor20.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button21.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor21.putString("checked54b","yes54b");
                    prefEditor21.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView21.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor21.putString("checked54b","false54b");
                    prefEditor21.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button22.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor22.putString("checked55b","yes55b");
                    prefEditor22.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView22.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor22.putString("checked55b","false55b");
                    prefEditor22.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button23.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor23.putString("checked56b","yes56b");
                    prefEditor23.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView23.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor23.putString("checked56b","false56b");
                    prefEditor23.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button24.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor24.putString("checked57b","yes57b");
                    prefEditor24.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView24.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor24.putString("checked57b","false57b");
                    prefEditor24.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button25.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor25.putString("checked58b","yes58b");
                    prefEditor25.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView25.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor25.putString("checked58b","false58b");
                    prefEditor25.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button26.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor26.putString("checked59b","yes59b");
                    prefEditor26.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView26.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor26.putString("checked59b","false59b");
                    prefEditor26.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button27.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor27.putString("checked60b","yes60b");
                    prefEditor27.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView27.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor27.putString("checked60b","false60b");
                    prefEditor27.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button28.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor28.putString("checked61b","yes61b");
                    prefEditor28.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView28.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor28.putString("checked61b","false61b");
                    prefEditor28.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button29.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor29.putString("checked62b","yes62b");
                    prefEditor29.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView29.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor29.putString("checked62b","false62b");
                    prefEditor29.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button30.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor30.putString("checked63b","yes63b");
                    prefEditor30.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView30.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor30.putString("checked63b","false63b");
                    prefEditor30.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button31.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor31.putString("checked64b","yes64b");
                    prefEditor31.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView31.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor31.putString("checked64b","false64b");
                    prefEditor31.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button32.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked65b","yes65b");
                    prefEditor32.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView32.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked65b","false65b");
                    prefEditor32.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button33.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor33.putString("checked66b","yes66b");
                    prefEditor33.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView33.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked66b","false66b");
                    prefEditor33.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        if (prefs.getString("checked34b","no34b").equals("yes34b")){
        ...
        if (prefs2.getString("checked35b","no35b").equals("yes35b")){
        ...
        if (prefs3.getString("checked36b","no36b").equals("yes36b")){
        ...
        if (prefs4.getString("checked37b","no37b").equals("yes37b")){
        ...
        if (prefs5.getString("checked38b","no38b").equals("yes38b")){
        ...
        if (prefs6.getString("checked39b","no39b").equals("yes39b")){
        ...
        if (prefs7.getString("checked40b","no40b").equals("yes40b")){
        ...
        if (prefs8.getString("checked41b","no41b").equals("yes41b")){
        ...
        if (prefs9.getString("checked42b","no42b").equals("yes42b")){
        ...
        if (prefs10.getString("checked43b","no43b").equals("yes43b")){
        ...
        if (prefs11.getString("checked44b","no44b").equals("yes44b")){
        ...
        if (prefs12.getString("checked45b","no45b").equals("yes45b")){
        ...
        if (prefs13.getString("checked46b","no46b").equals("yes46b")){
        ...
        if (prefs14.getString("checked47b","no47b").equals("yes47b")){
        ...
        if (prefs15.getString("checked48b","no48b").equals("yes48b")){
        ...
        if (prefs16.getString("checked49b","no49b").equals("yes49b")){
        ...
        if (prefs17.getString("checked50b","no50b").equals("yes50b")){
        ...
        if (prefs18.getString("checked51b","no51b").equals("yes51b")){
        ...
        if (prefs19.getString("checked52b","no52b").equals("yes52b")){
        ...
        if (prefs20.getString("checked53b","no53b").equals("yes53b")){
        ...
        if (prefs21.getString("checked54b","no54b").equals("yes54b")){
        ...
        if (prefs22.getString("checked55b","no55b").equals("yes55b")){
        ...
        if (prefs23.getString("checked56b","no56b").equals("yes56b")){
        ...
        if (prefs24.getString("checked57b","no57b").equals("yes57b")){
        ...
        if (prefs25.getString("checked58b","no58b").equals("yes58b")){
        ...
        if (prefs26.getString("checked59b","no59b").equals("yes59b")){
        ...
        if (prefs27.getString("checked60b","no60b").equals("yes60b")){
        ...
        if (prefs28.getString("checked61b","no61b").equals("yes61b")){
        ...
        if (prefs29.getString("checked62b","no62b").equals("yes62b")){
        ...
        if (prefs30.getString("checked63b","no63b").equals("yes63b")){
        ...
        if (prefs31.getString("checked64b","no64b").equals("yes64b")){
        ...
        if (prefs32.getString("checked65b","no65b").equals("yes65b")){
        ...
        if (prefs33.getString("checked66b","no66b").equals("yes66b")){
        ...
        pass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor8.putInt("lastScore8",score);
                editor8.apply();
