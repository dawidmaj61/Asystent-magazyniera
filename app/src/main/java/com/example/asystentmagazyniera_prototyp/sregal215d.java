...
public class sregal215d extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch_button.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor.putString("checked67df","yes67df");
                    prefEditor.apply();
                }else{
                    imageView.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor.putString("checked67df","false67df");
                    prefEditor.apply();
                }
            }
        });
        switch_button2.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor2.putString("checked68df","yes68df");
                    prefEditor2.apply();
                }else{
                    imageView2.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor2.putString("checked68df","false68df");
                    prefEditor2.apply();
                }
            }
        });
        switch_button3.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor3.putString("checked86df","yes86df");
                    prefEditor3.apply();
                }else{
                    imageView3.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor3.putString("checked86df","false86df");
                    prefEditor3.apply();
                }
            }
        });
        switch_button4.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor4.putString("checked69df","yes69df");
                    prefEditor4.apply();
                }else{
                    imageView4.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor4.putString("checked69df","false69df");
                    prefEditor4.apply();
                }
            }
        });
        switch_button5.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor5.putString("checked70df","yes70df");
                    prefEditor5.apply();
                }else{
                    imageView5.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor5.putString("checked70df","false70df");
                    prefEditor5.apply();
                }
            }
        });
        switch_button6.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor6.putString("checked71df","yes71df");
                    prefEditor6.apply();
                }else{
                    imageView6.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor6.putString("checked71df","false71df");
                    prefEditor6.apply();
                }
            }
        });
        switch_button7.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor7.putString("checked72df","yes72df");
                    prefEditor7.apply();
                }else{
                    imageView7.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor7.putString("checked72df","false72df");
                    prefEditor7.apply();
                }
            }
        });
        switch_button8.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor8.putString("checked73df","yes73df");
                    prefEditor8.apply();
                }else{
                    imageView8.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor8.putString("checked73df","false73df");
                    prefEditor8.apply();
                }
            }
        });
        switch_button9.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor9.putString("checked74df","yes74df");
                    prefEditor9.apply();
                }else{
                    imageView9.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor9.putString("checked74df","false74df");
                    prefEditor9.apply();
                }
            }
        });
        switch_button10.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor10.putString("checked75df","yes75df");
                    prefEditor10.apply();
                }else{
                    imageView10.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor10.putString("checked75df","false75df");
                    prefEditor10.apply();
                }
            }
        });
        switch_button11.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor11.putString("checked76df","yes76df");
                    prefEditor11.apply();
                }else{
                    imageView11.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor11.putString("checked76df","false76df");
                    prefEditor11.apply();
                }
            }
        });
        switch_button12.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor12.putString("checked77df","yes77df");
                    prefEditor12.apply();
                }else{
                    imageView12.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor12.putString("checked77df","false77df");
                    prefEditor12.apply();
                }
            }
        });
        switch_button13.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor13.putString("checked78df","yes78df");
                    prefEditor13.apply();
                }else{
                    imageView13.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor13.putString("checked78df","false78df");
                    prefEditor13.apply();
                }
            }
        });
        switch_button14.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor14.putString("checked79df","yes79df");
                    prefEditor14.apply();
                }else{
                    imageView14.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor14.putString("checked79df","false79df");
                    prefEditor14.apply();
                }
            }
        });
        switch_button15.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor15.putString("checked80df","yes80df");
                    prefEditor15.apply();
                }else{
                    imageView15.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor15.putString("checked80df","false80df");
                    prefEditor15.apply();
                }
            }
        });
        switch_button16.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor16.putString("checked81df","yes81df");
                    prefEditor16.apply();
                }else{
                    imageView16.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor16.putString("checked81df","false81df");
                    prefEditor16.apply();
                }
            }
        });
        switch_button17.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor17.putString("checked82df","yes82df");
                    prefEditor17.apply();
                }else{
                    imageView17.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor17.putString("checked82df","false82df");
                    prefEditor17.apply();
                }
            }
        });
        switch_button18.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor18.putString("checked83df","yes83df");
                    prefEditor18.apply();
                }else{
                    imageView18.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor18.putString("checked83df","false83df");
                    prefEditor18.apply();
                }
            }
        });
        switch_button19.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor19.putString("checked84df","yes84df");
                    prefEditor19.apply();
                }else{
                    imageView19.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor19.putString("checked84df","false84df");
                    prefEditor19.apply();
                }
            }
        });
        switch_button20.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor20.putString("checked85df","yes85df");
                    prefEditor20.apply();
                }else{
                    imageView20.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor20.putString("checked85df","false85df");
                    prefEditor20.apply();
                }
            }
        });
        switch_button21.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor21.putString("checked87df","yes87df");
                    prefEditor21.apply();
                }else{
                    imageView21.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor21.putString("checked87df","false87df");
                    prefEditor21.apply();
                }
            }
        });
        switch_button22.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor22.putString("checked88df","yes88df");
                    prefEditor22.apply();
                }else{
                    imageView22.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor22.putString("checked88df","false88df");
                    prefEditor22.apply();
                }
            }
        });
        switch_button23.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor23.putString("checked89df","yes89df");
                    prefEditor23.apply();
                }else{
                    imageView23.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor23.putString("checked89df","false89df");
                    prefEditor23.apply();
                }
            }
        });
        switch_button24.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor24.putString("checked90df","yes90df");
                    prefEditor24.apply();
                }else{
                    imageView24.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor24.putString("checked90df","false90df");
                    prefEditor24.apply();
                }
            }
        });
        switch_button25.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor25.putString("checked91df","yes91df");
                    prefEditor25.apply();
                }else{
                    imageView25.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor25.putString("checked91df","false91df");
                    prefEditor25.apply();
                }
            }
        });
        switch_button26.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor26.putString("checked92df","yes92df");
                    prefEditor26.apply();
                }else{
                    imageView26.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor26.putString("checked92df","false92df");
                    prefEditor26.apply();
                }
            }
        });
        switch_button27.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor27.putString("checked93df","yes93df");
                    prefEditor27.apply();
                }else{
                    imageView27.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor27.putString("checked93df","false93df");
                    prefEditor27.apply();
                }
            }
        });
        switch_button28.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor28.putString("checked94df","yes94df");
                    prefEditor28.apply();
                }else{
                    imageView28.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor28.putString("checked94df","false94df");
                    prefEditor28.apply();
                }
            }
        });
        switch_button29.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor29.putString("checked95df","yes95df");
                    prefEditor29.apply();
                }else{
                    imageView29.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor29.putString("checked95df","false95df");
                    prefEditor29.apply();
                }
            }
        });
        switch_button30.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor30.putString("checked96df","yes96df");
                    prefEditor30.apply();
                }else{
                    imageView30.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor30.putString("checked96df","false96df");
                    prefEditor30.apply();
                }
            }
        });
        switch_button31.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor31.putString("checked97df","yes97df");
                    prefEditor31.apply();
                }else{
                    imageView31.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor31.putString("checked97df","false97df");
                    prefEditor31.apply();
                }
            }
        });
        switch_button32.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked98df","yes98df");
                    prefEditor32.apply();
                }else{
                    imageView32.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked98df","false98df");
                    prefEditor32.apply();
                }
            }
        });
        switch_button33.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal215d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor33.putString("checked99df","yes99df");
                    prefEditor33.apply();
                }else{
                    imageView33.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal215d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked99df","false99df");
                    prefEditor33.apply();
                }
            }
        });
        ...
        if (prefs.getString("checked67df","no67df").equals("yes67df")){
        ...
        if (prefs2.getString("checked68df","no68df").equals("yes68df")){
        ...
        if (prefs3.getString("checked86df","no86df").equals("yes86df")){
        ...
        if (prefs4.getString("checked69df","no69df").equals("yes69df")){
        ...
        if (prefs5.getString("checked70df","no70df").equals("yes70df")){
        ...
        if (prefs6.getString("checked83df","no83df").equals("yes83df")){
        ...
        if (prefs7.getString("checked71df","no71df").equals("yes71df")){
        ...
        if (prefs8.getString("checked72df","no72df").equals("yes72df")){
        ...
        if (prefs9.getString("checked73df","no73df").equals("yes73df")){
        ...
        if (prefs10.getString("checked74df","no74df").equals("yes74df")){
        ...
        if (prefs11.getString("checked75df","no75df").equals("yes75df")){
        ...
        if (prefs12.getString("checked76df","no76df").equals("yes76df")){
        ...
        if (prefs13.getString("checked77df","no77df").equals("yes77df")){
        ...
        if (prefs14.getString("checked78df","no78df").equals("yes78df")){
        ...
        if (prefs15.getString("checked79df","no79df").equals("yes79df")){
        ...
        if (prefs16.getString("checked80df","no80df").equals("yes80df")){
        ...
        if (prefs17.getString("checked81df","no81df").equals("yes81df")){
        ...
        if (prefs18.getString("checked82df","no82df").equals("yes82df")){
        ...
        if (prefs19.getString("checked84df","no84df").equals("yes84df")){
        ...
        if (prefs20.getString("checked85df","no85df").equals("yes85df")){
        ...
        if (prefs21.getString("checked87df","no87df").equals("yes87df")){
        ...
        if (prefs22.getString("checked88df","no88df").equals("yes88df")){
        ...
        if (prefs23.getString("checked89df","no89df").equals("yes89df")){
        ...
        if (prefs24.getString("checked90df","no90df").equals("yes90df")){
        ...
        if (prefs25.getString("checked91df","no91df").equals("yes91df")){
        ...
        if (prefs26.getString("checked92df","no92df").equals("yes92df")){
        ...
        if (prefs27.getString("checked93df","no93df").equals("yes93df")){
        ...
        if (prefs28.getString("checked94df","no94df").equals("yes94df")){
        ...
        if (prefs29.getString("checked95df","no95df").equals("yes95df")){
        ...
        if (prefs30.getString("checked96df","no96df").equals("yes96df")){
        ...
        if (prefs31.getString("checked97df","no97df").equals("yes97df")){
        ...
        if (prefs32.getString("checked98df","no98df").equals("yes98df")){
        ...
        if (prefs33.getString("checked99df","no99df").equals("yes99df")){
