...
public class regal218 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_regal218);
        ...
        switch_button.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor.putString("checked67a","yes67a");
                    prefEditor.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor.putString("checked67a","false67a");
                    prefEditor.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button2.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor2.putString("checked68a","yes68a");
                    prefEditor2.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView2.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor2.putString("checked68a","false68a");
                    prefEditor2.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button3.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor3.putString("checked86a","yes86a");
                    prefEditor3.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView3.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor3.putString("checked86a","false86a");
                    prefEditor3.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button4.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor4.putString("checked69a","yes69a");
                    prefEditor4.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView4.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor4.putString("checked69a","false69a");
                    prefEditor4.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button5.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor5.putString("checked70a","yes70a");
                    prefEditor5.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView5.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor5.putString("checked70a","false70a");
                    prefEditor5.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button6.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor6.putString("checked71a","yes71a");
                    prefEditor6.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView6.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor6.putString("checked71a","false71a");
                    prefEditor6.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button7.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor7.putString("checked72a","yes72a");
                    prefEditor7.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView7.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor7.putString("checked72a","false72a");
                    prefEditor7.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button8.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor8.putString("checked73a","yes73a");
                    prefEditor8.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView8.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor8.putString("checked73a","false73a");
                    prefEditor8.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button9.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor9.putString("checked74a","yes74a");
                    prefEditor9.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView9.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor9.putString("checked74a","false74a");
                    prefEditor9.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button10.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor10.putString("checked75a","yes75a");
                    prefEditor10.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView10.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor10.putString("checked75a","false75a");
                    prefEditor10.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button11.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor11.putString("checked76a","yes76a");
                    prefEditor11.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView11.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor11.putString("checked76a","false76a");
                    prefEditor11.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button12.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor12.putString("checked77a","yes77a");
                    prefEditor12.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView12.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor12.putString("checked77a","false77a");
                    prefEditor12.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button13.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor13.putString("checked78a","yes78a");
                    prefEditor13.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView13.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor13.putString("checked78a","false78a");
                    prefEditor13.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button14.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor14.putString("checked79a","yes79a");
                    prefEditor14.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView14.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor14.putString("checked79a","false79a");
                    prefEditor14.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button15.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor15.putString("checked80a","yes80a");
                    prefEditor15.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView15.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor15.putString("checked80a","false80a");
                    prefEditor15.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button16.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor16.putString("checked81a","yes81a");
                    prefEditor16.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView16.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor16.putString("checked81a","false81a");
                    prefEditor16.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button17.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor17.putString("checked82a","yes82a");
                    prefEditor17.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView17.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor17.putString("checked82a","false82a");
                    prefEditor17.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button18.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor18.putString("checked83a","yes83a");
                    prefEditor18.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView18.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor18.putString("checked83a","false83a");
                    prefEditor18.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button19.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor19.putString("checked84a","yes84a");
                    prefEditor19.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView19.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor19.putString("checked84a","false84a");
                    prefEditor19.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button20.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor20.putString("checked85a","yes85a");
                    prefEditor20.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView20.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor20.putString("checked85a","false85a");
                    prefEditor20.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button21.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor21.putString("checked87a","yes87a");
                    prefEditor21.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView21.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor21.putString("checked87a","false87a");
                    prefEditor21.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button22.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor22.putString("checked88a","yes88a");
                    prefEditor22.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView22.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor22.putString("checked88a","false88a");
                    prefEditor22.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button23.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor23.putString("checked89a","yes89a");
                    prefEditor23.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView23.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor23.putString("checked89a","false89a");
                    prefEditor23.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button24.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor24.putString("checked90a","yes90a");
                    prefEditor24.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView24.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor24.putString("checked90a","false90a");
                    prefEditor24.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button25.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor25.putString("checked91a","yes91a");
                    prefEditor25.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView25.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor25.putString("checked91a","false91a");
                    prefEditor25.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button26.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor26.putString("checked92a","yes92a");
                    prefEditor26.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView26.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor26.putString("checked92a","false92a");
                    prefEditor26.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button27.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor27.putString("checked93a","yes93a");
                    prefEditor27.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView27.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor27.putString("checked93a","false93a");
                    prefEditor27.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button28.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor28.putString("checked94a","yes94a");
                    prefEditor28.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView28.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor28.putString("checked94a","false94a");
                    prefEditor28.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button29.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor29.putString("checked95a","yes95a");
                    prefEditor29.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView29.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor29.putString("checked95a","false95a");
                    prefEditor29.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button30.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor30.putString("checked96a","yes96a");
                    prefEditor30.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView30.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor30.putString("checked96a","false96a");
                    prefEditor30.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button31.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor31.putString("checked97a","yes97a");
                    prefEditor31.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView31.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor31.putString("checked97a","false97a");
                    prefEditor31.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button32.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked98a","yes98a");
                    prefEditor32.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView32.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked98a","false98a");
                    prefEditor32.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button33.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor33.putString("checked99a","yes99a");
                    prefEditor33.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView33.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked99a","false99a");
                    prefEditor33.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        if (prefs.getString("checked67a","no67a").equals("yes67a")){
        ...
        if (prefs2.getString("checked68a","no68a").equals("yes68a")){
        ...
        if (prefs3.getString("checked86a","no86a").equals("yes86a")){
        ...
        if (prefs4.getString("checked69a","no69a").equals("yes69a")){
        ...
        if (prefs5.getString("checked70a","no70a").equals("yes70a")){
        ...
        if (prefs6.getString("checked83a","no83a").equals("yes83a")){
        ...
        if (prefs7.getString("checked71a","no71a").equals("yes71a")){
        ...
        if (prefs8.getString("checked72a","no72a").equals("yes72a")){
        ...
        if (prefs9.getString("checked73a","no73a").equals("yes73a")){
        ...
        if (prefs10.getString("checked74a","no74a").equals("yes74a")){
        ...
        if (prefs11.getString("checked75a","no75a").equals("yes75a")){
        ...
        if (prefs12.getString("checked76a","no76a").equals("yes76a")){
        ...
        if (prefs13.getString("checked77a","no77a").equals("yes77a")){
        ...
        if (prefs14.getString("checked78a","no78a").equals("yes78a")){
        ...
        if (prefs15.getString("checked79a","no79a").equals("yes79a")){
        ...
        if (prefs16.getString("checked80a","no80a").equals("yes80a")){
        ...
        if (prefs17.getString("checked81a","no81a").equals("yes81a")){
        ...
        if (prefs18.getString("checked82a","no82a").equals("yes82a")){
        ...
        if (prefs19.getString("checked84a","no84a").equals("yes84a")){
        ...
        if (prefs20.getString("checked85a","no85a").equals("yes85a")){
        ...
        if (prefs21.getString("checked87a","no87a").equals("yes87a")){
        ...
        if (prefs22.getString("checked88a","no88a").equals("yes88a")){
        ...
        if (prefs23.getString("checked89a","no89a").equals("yes89a")){
        ...
        if (prefs24.getString("checked90a","no90a").equals("yes90a")){
        ...
        if (prefs25.getString("checked91a","no91a").equals("yes91a")){
        ...
        if (prefs26.getString("checked92a","no92a").equals("yes92a")){
        ...
        if (prefs27.getString("checked93a","no93a").equals("yes93a")){
        ...
        if (prefs28.getString("checked94a","no94a").equals("yes94a")){
        ...
        if (prefs29.getString("checked95a","no95a").equals("yes95a")){
        ...
        if (prefs30.getString("checked96a","no96a").equals("yes96a")){
        ...
        if (prefs31.getString("checked97a","no97a").equals("yes97a")){
        ...
        if (prefs32.getString("checked98a","no98a").equals("yes98a")){
        ...
        if (prefs33.getString("checked99a","no99a").equals("yes99a")){
        ...
        pass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor6.putInt("lastScore6",score);
                editor6.apply();
