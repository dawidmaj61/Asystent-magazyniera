...
public class regal221 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_regal222);
        ...
        switch_button.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor.putString("checked67b","yes67b");
                    prefEditor.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor.putString("checked67b","false67b");
                    prefEditor.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button2.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor2.putString("checked68b","yes68b");
                    prefEditor2.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView2.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor2.putString("checked68b","false68b");
                    prefEditor2.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button3.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor3.putString("checked86b","yes86b");
                    prefEditor3.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView3.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor3.putString("checked86b","false86b");
                    prefEditor3.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button4.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor4.putString("checked69b","yes69b");
                    prefEditor4.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView4.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor4.putString("checked69b","false69b");
                    prefEditor4.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button5.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor5.putString("checked70b","yes70b");
                    prefEditor5.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView5.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor5.putString("checked70b","false70b");
                    prefEditor5.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button6.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor6.putString("checked71b","yes71b");
                    prefEditor6.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView6.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor6.putString("checked71b","false71b");
                    prefEditor6.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button7.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor7.putString("checked72b","yes72b");
                    prefEditor7.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView7.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor7.putString("checked72b","false72b");
                    prefEditor7.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button8.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor8.putString("checked73b","yes73b");
                    prefEditor8.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView8.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor8.putString("checked73b","false73b");
                    prefEditor8.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button9.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor9.putString("checked74b","yes74b");
                    prefEditor9.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView9.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor9.putString("checked74b","false74b");
                    prefEditor9.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button10.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor10.putString("checked75b","yes75b");
                    prefEditor10.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView10.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor10.putString("checked75b","false75b");
                    prefEditor10.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button11.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor11.putString("checked76b","yes76b");
                    prefEditor11.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView11.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor11.putString("checked76b","false76b");
                    prefEditor11.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button12.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor12.putString("checked77b","yes77b");
                    prefEditor12.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView12.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor12.putString("checked77b","false77b");
                    prefEditor12.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button13.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor13.putString("checked78b","yes78b");
                    prefEditor13.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView13.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor13.putString("checked78b","false78b");
                    prefEditor13.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button14.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor14.putString("checked79b","yes79b");
                    prefEditor14.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView14.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor14.putString("checked79b","false79b");
                    prefEditor14.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button15.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor15.putString("checked80b","yes80b");
                    prefEditor15.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView15.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor15.putString("checked80b","false80b");
                    prefEditor15.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button16.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor16.putString("checked81b","yes81b");
                    prefEditor16.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView16.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor16.putString("checked81b","false81b");
                    prefEditor16.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button17.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor17.putString("checked82b","yes82b");
                    prefEditor17.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView17.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor17.putString("checked82b","false82b");
                    prefEditor17.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button18.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor18.putString("checked83b","yes83b");
                    prefEditor18.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView18.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor18.putString("checked83b","false83b");
                    prefEditor18.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button19.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor19.putString("checked84b","yes84b");
                    prefEditor19.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView19.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor19.putString("checked84b","false84b");
                    prefEditor19.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button20.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor20.putString("checked85b","yes85b");
                    prefEditor20.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView20.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor20.putString("checked85b","false85b");
                    prefEditor20.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button21.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor21.putString("checked87b","yes87b");
                    prefEditor21.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView21.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor21.putString("checked87b","false87b");
                    prefEditor21.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button22.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor22.putString("checked88b","yes88b");
                    prefEditor22.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView22.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor22.putString("checked88b","false88b");
                    prefEditor22.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button23.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor23.putString("checked89b","yes89b");
                    prefEditor23.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView23.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor23.putString("checked89b","false89b");
                    prefEditor23.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button24.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor24.putString("checked90b","yes90b");
                    prefEditor24.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView24.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor24.putString("checked90b","false90b");
                    prefEditor24.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button25.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor25.putString("checked91b","yes91b");
                    prefEditor25.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView25.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor25.putString("checked91b","false91b");
                    prefEditor25.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button26.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor26.putString("checked92b","yes92b");
                    prefEditor26.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView26.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor26.putString("checked92b","false92b");
                    prefEditor26.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button27.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor27.putString("checked93b","yes93b");
                    prefEditor27.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView27.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor27.putString("checked93b","false93b");
                    prefEditor27.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button28.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor28.putString("checked94b","yes94b");
                    prefEditor28.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView28.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor28.putString("checked94b","false94b");
                    prefEditor28.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button29.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor29.putString("checked95b","yes95b");
                    prefEditor29.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView29.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor29.putString("checked95b","false95b");
                    prefEditor29.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button30.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor30.putString("checked96b","yes96b");
                    prefEditor30.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView30.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor30.putString("checked96b","false96b");
                    prefEditor30.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button31.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor31.putString("checked97b","yes97b");
                    prefEditor31.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView31.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor31.putString("checked97b","false97b");
                    prefEditor31.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button32.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked98b","yes98b");
                    prefEditor32.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView32.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked98b","false98b");
                    prefEditor32.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button33.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal221.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor33.putString("checked99b","yes99b");
                    prefEditor33.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView33.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal221.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked99b","false99b");
                    prefEditor33.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        if (prefs.getString("checked67b","no67b").equals("yes67b")){
        ...
        if (prefs2.getString("checked68b","no68b").equals("yes68b")){
        ...
        if (prefs3.getString("checked86b","no86b").equals("yes86b")){
        ...
        if (prefs4.getString("checked69b","no69b").equals("yes69b")){
        ...
        if (prefs5.getString("checked70b","no70b").equals("yes70b")){
        ...
        if (prefs6.getString("checked83b","no83b").equals("yes83b")){
        ...
        if (prefs7.getString("checked71b","no71b").equals("yes71b")){
        ...
        if (prefs8.getString("checked72b","no72b").equals("yes72b")){
        ...
        if (prefs9.getString("checked73b","no73b").equals("yes73b")){
        ...
        if (prefs10.getString("checked74b","no74b").equals("yes74b")){
        ...
        if (prefs11.getString("checked75b","no75b").equals("yes75b")){
        ...
        if (prefs12.getString("checked76b","no76b").equals("yes76b")){
        ...
        if (prefs13.getString("checked77b","no77b").equals("yes77b")){
        ...
        if (prefs14.getString("checked78b","no78b").equals("yes78b")){
        ...
        if (prefs15.getString("checked79b","no79b").equals("yes79b")){
        ...
        if (prefs16.getString("checked80b","no80b").equals("yes80b")){
        ...
        if (prefs17.getString("checked81b","no81b").equals("yes81b")){
        ...
        if (prefs18.getString("checked82b","no82b").equals("yes82b")){
        ...
        if (prefs19.getString("checked84b","no84b").equals("yes84b")){
        ...
        if (prefs20.getString("checked85b","no85b").equals("yes85b")){
        ...
        if (prefs21.getString("checked87b","no87b").equals("yes87b")){
        ...
        if (prefs22.getString("checked88b","no88b").equals("yes88b")){
        ...
        if (prefs23.getString("checked89b","no89b").equals("yes89b")){
        ...
        if (prefs24.getString("checked90b","no90b").equals("yes90b")){
        ...
        if (prefs25.getString("checked91b","no91b").equals("yes91b")){
        ...
        if (prefs26.getString("checked92b","no92b").equals("yes92b")){
        ...
        if (prefs27.getString("checked93b","no93b").equals("yes93b")){
        ...
        if (prefs28.getString("checked94b","no94b").equals("yes94b")){
        ...
        if (prefs29.getString("checked95b","no95b").equals("yes95b")){
        ...
        if (prefs30.getString("checked96b","no96b").equals("yes96b")){
        ...
        if (prefs31.getString("checked97b","no97b").equals("yes97b")){
        ...
        if (prefs32.getString("checked98b","no98b").equals("yes98b")){
        ...
        if (prefs33.getString("checked99b","no99b").equals("yes99b")){
        ...
        pass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor9.putInt("lastScore9",score);
                editor9.apply();
