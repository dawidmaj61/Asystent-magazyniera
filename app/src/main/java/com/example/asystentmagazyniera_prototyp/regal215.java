...
public class regal215 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_regal215);
        ...
        switch_button.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor.putString("checked67","yes67");
                    prefEditor.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                    ...
                    imageView.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor.putString("checked67","false67");
                    prefEditor.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button2.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor2.putString("checked68","yes68");
                    prefEditor2.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView2.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor2.putString("checked68","false68");
                    prefEditor2.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button3.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor3.putString("checked86","yes86");
                    prefEditor3.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView3.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor3.putString("checked86","false86");
                    prefEditor3.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button4.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor4.putString("checked69","yes69");
                    prefEditor4.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView4.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor4.putString("checked69","false69");
                    prefEditor4.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button5.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor5.putString("checked70","yes70");
                    prefEditor5.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView5.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor5.putString("checked70","false70");
                    prefEditor5.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button6.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor6.putString("checked71","yes71");
                    prefEditor6.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView6.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor6.putString("checked71","false71");
                    prefEditor6.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button7.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor7.putString("checked72","yes72");
                    prefEditor7.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView7.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor7.putString("checked72","false72");
                    prefEditor7.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button8.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor8.putString("checked73","yes73");
                    prefEditor8.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView8.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor8.putString("checked73","false73");
                    prefEditor8.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button9.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor9.putString("checked74","yes74");
                    prefEditor9.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView9.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor9.putString("checked74","false74");
                    prefEditor9.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button10.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor10.putString("checked75","yes75");
                    prefEditor10.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView10.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor10.putString("checked75","false75");
                    prefEditor10.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button11.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor11.putString("checked76","yes76");
                    prefEditor11.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView11.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor11.putString("checked76","false76");
                    prefEditor11.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button12.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor12.putString("checked77","yes77");
                    prefEditor12.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView12.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor12.putString("checked77","false77");
                    prefEditor12.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button13.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor13.putString("checked78","yes78");
                    prefEditor13.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView13.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor13.putString("checked78","false78");
                    prefEditor13.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button14.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor14.putString("checked79","yes79");
                    prefEditor14.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView14.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor14.putString("checked79","false79");
                    prefEditor14.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button15.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor15.putString("checked80","yes80");
                    prefEditor15.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView15.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor15.putString("checked80","false80");
                    prefEditor15.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button16.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor16.putString("checked81","yes81");
                    prefEditor16.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView16.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor16.putString("checked81","false81");
                    prefEditor16.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button17.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor17.putString("checked82","yes82");
                    prefEditor17.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView17.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor17.putString("checked82","false82");
                    prefEditor17.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button18.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor18.putString("checked83","yes83");
                    prefEditor18.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView18.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor18.putString("checked83","false83");
                    prefEditor18.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button19.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor19.putString("checked84","yes84");
                    prefEditor19.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView19.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor19.putString("checked84","false84");
                    prefEditor19.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button20.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor20.putString("checked85","yes85");
                    prefEditor20.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView20.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor20.putString("checked85","false85");
                    prefEditor20.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button21.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor21.putString("checked87","yes87");
                    prefEditor21.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView21.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor21.putString("checked87","false87");
                    prefEditor21.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button22.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor22.putString("checked88","yes88");
                    prefEditor22.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView22.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor22.putString("checked88","false88");
                    prefEditor22.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button23.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor23.putString("checked89","yes89");
                    prefEditor23.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView23.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor23.putString("checked89","false89");
                    prefEditor23.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button24.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor24.putString("checked90","yes90");
                    prefEditor24.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView24.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor24.putString("checked90","false90");
                    prefEditor24.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button25.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor25.putString("checked91","yes91");
                    prefEditor25.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView25.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor25.putString("checked91","false91");
                    prefEditor25.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button26.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor26.putString("checked92","yes92");
                    prefEditor26.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView26.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor26.putString("checked92","false92");
                    prefEditor26.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button27.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor27.putString("checked93","yes93");
                    prefEditor27.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView27.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor27.putString("checked93","false93");
                    prefEditor27.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button28.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor28.putString("checked94","yes94");
                    prefEditor28.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView28.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor28.putString("checked94","false94");
                    prefEditor28.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button29.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor29.putString("checked95","yes95");
                    prefEditor29.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView29.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor29.putString("checked95","false95");
                    prefEditor29.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button30.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor30.putString("checked96","yes96");
                    prefEditor30.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView30.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor30.putString("checked96","false96");
                    prefEditor30.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button31.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor31.putString("checked97","yes97");
                    prefEditor31.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView31.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor31.putString("checked97","false97");
                    prefEditor31.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button32.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked98","yes98");
                    prefEditor32.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView32.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked98","false98");
                    prefEditor32.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button33.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(regal215.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor33.putString("checked99","yes99");
                    prefEditor33.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView33.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(regal215.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked99","false99");
                    prefEditor33.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        if (prefs.getString("checked67","no67").equals("yes67")){
        ...
        if (prefs2.getString("checked68","no68").equals("yes68")){
        ...
        if (prefs3.getString("checked86","no86").equals("yes86")){
        ...
        if (prefs4.getString("checked69","no69").equals("yes69")){
        ...
        if (prefs5.getString("checked70","no70").equals("yes70")){
        ...
        if (prefs6.getString("checked83","no83").equals("yes83")){
        ...
        if (prefs7.getString("checked71","no71").equals("yes71")){
        ...
        if (prefs8.getString("checked72","no72").equals("yes72")){
        ...
        if (prefs9.getString("checked73","no73").equals("yes73")){
        ...
        if (prefs10.getString("checked74","no74").equals("yes74")){
        ...
        if (prefs11.getString("checked75","no75").equals("yes75")){
        ...
        if (prefs12.getString("checked76","no76").equals("yes76")){
        ...
        if (prefs13.getString("checked77","no77").equals("yes77")){
        ...
        if (prefs14.getString("checked78","no78").equals("yes78")){
        ...
        if (prefs15.getString("checked79","no79").equals("yes79")){
        ...
        if (prefs16.getString("checked80","no80").equals("yes80")){
        ...
        if (prefs17.getString("checked81","no81").equals("yes81")){
        ...
        if (prefs18.getString("checked82","no82").equals("yes82")){
        ...
        if (prefs19.getString("checked84","no84").equals("yes84")){
        ...
        if (prefs20.getString("checked85","no85").equals("yes85")){
        ...
        if (prefs21.getString("checked87","no87").equals("yes87")){
        ...
        if (prefs22.getString("checked88","no88").equals("yes88")){
        ...
        if (prefs23.getString("checked89","no89").equals("yes89")){
        ...
        if (prefs24.getString("checked90","no90").equals("yes90")){
        ...
        if (prefs25.getString("checked91","no91").equals("yes91")){
        ...
        if (prefs26.getString("checked92","no92").equals("yes92")){
        ...
        if (prefs27.getString("checked93","no93").equals("yes93")){
        ...
        if (prefs28.getString("checked94","no94").equals("yes94")){
        ...
        if (prefs29.getString("checked95","no95").equals("yes95")){
        ...
        if (prefs30.getString("checked96","no96").equals("yes96")){
        ...
        if (prefs31.getString("checked97","no97").equals("yes97")){
        ...
        if (prefs32.getString("checked98","no98").equals("yes98")){
        ...
        if (prefs33.getString("checked99","no99").equals("yes99")){
        ...
        pass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor3.putInt("lastScore3",score);
                editor3.apply();
