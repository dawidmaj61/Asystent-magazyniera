...
public class sregal221d extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch_button.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor.putString("checked67bdf","yes67bdf");
                    prefEditor.apply();
                }else{
                    imageView.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor.putString("checked67bdf","false67bdf");
                    prefEditor.apply();
                }
            }
        });
        switch_button2.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor2.putString("checked68bdf","yes68bdf");
                    prefEditor2.apply();
                }else{
                    imageView2.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor2.putString("checked68bdf","false68bdf");
                    prefEditor2.apply();
                }
            }
        });
        switch_button3.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor3.putString("checked86bdf","yes86bdf");
                    prefEditor3.apply();
                }else{
                    imageView3.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor3.putString("checked86bdf","false86bdf");
                    prefEditor3.apply();
                }
            }
        });
        switch_button4.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor4.putString("checked69bdf","yes69bdf");
                    prefEditor4.apply();
                }else{
                    imageView4.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor4.putString("checked69bdf","false69bdf");
                    prefEditor4.apply();
                }
            }
        });
        switch_button5.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor5.putString("checked70bdf","yes70bdf");
                    prefEditor5.apply();
                }else{
                    imageView5.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor5.putString("checked70bdf","false70bdf");
                    prefEditor5.apply();
                }
            }
        });
        switch_button6.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor6.putString("checked71bdf","yes71bdf");
                    prefEditor6.apply();
                }else{
                    imageView6.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor6.putString("checked71bdf","false71bdf");
                    prefEditor6.apply();
                }
            }
        });
        switch_button7.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor7.putString("checked72bdf","yes72bdf");
                    prefEditor7.apply();
                }else{
                    imageView7.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor7.putString("checked72bdf","false72bdf");
                    prefEditor7.apply();
                }
            }
        });
        switch_button8.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor8.putString("checked73bdf","yes73bdf");
                    prefEditor8.apply();
                }else{
                    imageView8.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor8.putString("checked73bdf","false73bdf");
                    prefEditor8.apply();
                }
            }
        });
        switch_button9.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor9.putString("checked74bdf","yes74bdf");
                    prefEditor9.apply();
                }else{
                    imageView9.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor9.putString("checked74bdf","false74bdf");
                    prefEditor9.apply();
                }
            }
        });
        switch_button10.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor10.putString("checked75bdf","yes75bdf");
                    prefEditor10.apply();
                }else{
                    imageView10.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor10.putString("checked75bdf","false75bdf");
                    prefEditor10.apply();
                }
            }
        });
        switch_button11.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor11.putString("checked76bdf","yes76bdf");
                    prefEditor11.apply();
                }else{
                    imageView11.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor11.putString("checked76bdf","false76bdf");
                    prefEditor11.apply();
                }
            }
        });
        switch_button12.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor12.putString("checked77bdf","yes77bdf");
                    prefEditor12.apply();
                }else{
                    imageView12.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor12.putString("checked77bdf","false77bdf");
                    prefEditor12.apply();
                }
            }
        });
        switch_button13.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor13.putString("checked78bdf","yes78bdf");
                    prefEditor13.apply();
                }else{
                    imageView13.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor13.putString("checked78bdf","false78bdf");
                    prefEditor13.apply();
                }
            }
        });
        switch_button14.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor14.putString("checked79bdf","yes79bdf");
                    prefEditor14.apply();
                }else{
                    imageView14.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor14.putString("checked79bdf","false79bdf");
                    prefEditor14.apply();
                }
            }
        });
        switch_button15.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor15.putString("checked80bdf","yes80bdf");
                    prefEditor15.apply();
                }else{
                    imageView15.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor15.putString("checked80bdf","false80bdf");
                    prefEditor15.apply();
                }
            }
        });
        switch_button16.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor16.putString("checked81bdf","yes81bdf");
                    prefEditor16.apply();
                }else{
                    imageView16.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor16.putString("checked81bdf","false81bdf");
                    prefEditor16.apply();
                }
            }
        });
        switch_button17.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor17.putString("checked82bdf","yes82bdf");
                    prefEditor17.apply();
                }else{
                    imageView17.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor17.putString("checked82bdf","false82bdf");
                    prefEditor17.apply();
                }
            }
        });
        switch_button18.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor18.putString("checked83bdf","yes83bdf");
                    prefEditor18.apply();
                }else{
                    imageView18.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor18.putString("checked83bdf","false83bdf");
                    prefEditor18.apply();
                }
            }
        });
        switch_button19.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor19.putString("checked84bdf","yes84bdf");
                    prefEditor19.apply();
                }else{
                    imageView19.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor19.putString("checked84bdf","false84bdf");
                    prefEditor19.apply();
                }
            }
        });
        switch_button20.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor20.putString("checked85bdf","yes85bdf");
                    prefEditor20.apply();
                }else{
                    imageView20.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor20.putString("checked85bdf","false85bdf");
                    prefEditor20.apply();
                }
            }
        });
        switch_button21.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor21.putString("checked87bdf","yes87bdf");
                    prefEditor21.apply();
                }else{
                    imageView21.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor21.putString("checked87bdf","false87bdf");
                    prefEditor21.apply();
                }
            }
        });
        switch_button22.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor22.putString("checked88bdf","yes88bdf");
                    prefEditor22.apply();
                }else{
                    imageView22.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor22.putString("checked88bdf","false88bdf");
                    prefEditor22.apply();
                }
            }
        });
        switch_button23.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor23.putString("checked89bdf","yes89bdf");
                    prefEditor23.apply();
                }else{
                    imageView23.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor23.putString("checked89bdf","false89bdf");
                    prefEditor23.apply();
                }
            }
        });
        switch_button24.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor24.putString("checked90bdf","yes90bdf");
                    prefEditor24.apply();
                }else{
                    imageView24.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor24.putString("checked90bdf","false90bdf");
                    prefEditor24.apply();
                }
            }
        });
        switch_button25.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor25.putString("checked91bdf","yes91bdf");
                    prefEditor25.apply();
                }else{
                    imageView25.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor25.putString("checked91bdf","false91bdf");
                    prefEditor25.apply();
                }
            }
        });
        switch_button26.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor26.putString("checked92bdf","yes92bdf");
                    prefEditor26.apply();
                }else{
                    imageView26.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor26.putString("checked92bdf","false92bdf");
                    prefEditor26.apply();
                }
            }
        });
        switch_button27.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor27.putString("checked93bdf","yes93bdf");
                    prefEditor27.apply();
                }else{
                    imageView27.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor27.putString("checked93bdf","false93bdf");
                    prefEditor27.apply();
                }
            }
        });
        switch_button28.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor28.putString("checked94bdf","yes94bdf");
                    prefEditor28.apply();
                }else{
                    imageView28.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor28.putString("checked94bdf","false94bdf");
                    prefEditor28.apply();
                }
            }
        });
        switch_button29.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor29.putString("checked95bdf","yes95bdf");
                    prefEditor29.apply();
                }else{
                    imageView29.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor29.putString("checked95bdf","false95bdf");
                    prefEditor29.apply();
                }
            }
        });
        switch_button30.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor30.putString("checked96bdf","yes96bdf");
                    prefEditor30.apply();
                }else{
                    imageView30.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor30.putString("checked96bdf","false96bdf");
                    prefEditor30.apply();
                }
            }
        });
        switch_button31.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor31.putString("checked97bdf","yes97bdf");
                    prefEditor31.apply();
                }else{
                    imageView31.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor31.putString("checked97bdf","false97bdf");
                    prefEditor31.apply();
                }
            }
        });
        switch_button32.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked98bdf","yes98bdf");
                    prefEditor32.apply();
                }else{
                    imageView32.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked98bdf","false98bdf");
                    prefEditor32.apply();
                }
            }
        });
        switch_button33.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal221d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor33.putString("checked999bdf","yes999bdf");
                    prefEditor33.apply();
                }else{
                    imageView33.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal221d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked999bdf","false999bdf");
                    prefEditor33.apply();
                }
            }
        });
        ...
        if (prefs.getString("checked67bdf","no67bdf").equals("yes67bdf")){
        ...
        if (prefs2.getString("checked68bdf","no68bdf").equals("yes68bdf")){
        ...
        if (prefs3.getString("checked86bdf","no86bdf").equals("yes86bdf")){
        ...
        if (prefs4.getString("checked69bdf","no69bdf").equals("yes69bdf")){
        ...
        if (prefs5.getString("checked70bdf","no70bdf").equals("yes70bdf")){
        ...
        if (prefs6.getString("checked83bdf","no83bdf").equals("yes83bdf")){
        ...
        if (prefs7.getString("checked71bdf","no71bdf").equals("yes71bdf")){
        ...
        if (prefs8.getString("checked72bdf","no72bdf").equals("yes72bdf")){
        ...
        if (prefs9.getString("checked73bdf","no73bdf").equals("yes73bdf")){
        ...
        if (prefs10.getString("checked74bdf","no74bdf").equals("yes74bdf")){
        ...
        if (prefs11.getString("checked75bdf","no75bdf").equals("yes75bdf")){
        ...
        if (prefs12.getString("checked76bdf","no76bdf").equals("yes76bdf")){
        ...
        if (prefs13.getString("checked77bdf","no77bdf").equals("yes77bdf")){
        ...
        if (prefs14.getString("checked78bdf","no78bdf").equals("yes78bdf")){
        ...
        if (prefs15.getString("checked79bdf","no79bdf").equals("yes79bdf")){
        ...
        if (prefs16.getString("checked80bdf","no80bdf").equals("yes80bdf")){
        ...
        if (prefs17.getString("checked81bdf","no81bdf").equals("yes81bdf")){
        ...
        if (prefs18.getString("checked82bdf","no82bdf").equals("yes82bdf")){
        ...
        if (prefs19.getString("checked84bdf","no84bdf").equals("yes84bdf")){
        ...
        if (prefs20.getString("checked85bdf","no85bdf").equals("yes85bdf")){
        ...
        if (prefs21.getString("checked87bdf","no87bdf").equals("yes87bdf")){
        ...
        if (prefs22.getString("checked88bdf","no88bdf").equals("yes88bdf")){
        ...
        if (prefs23.getString("checked89bdf","no89bdf").equals("yes89bdf")){
        ...
        if (prefs24.getString("checked90bdf","no90bdf").equals("yes90bdf")){
        ...
        if (prefs25.getString("checked91bdf","no91bdf").equals("yes91bdf")){
        ...
        if (prefs26.getString("checked92bdf","no92bdf").equals("yes92bdf")){
        ...
        if (prefs27.getString("checked93bdf","no93bdf").equals("yes93bdf")){
        ...
        if (prefs28.getString("checked94bdf","no94bdf").equals("yes94bdf")){
        ...
        if (prefs29.getString("checked95bdf","no95bf").equals("yes95bdf")){
        ...
        if (prefs30.getString("checked96bdf","no96bdf").equals("yes96bdf")){
        ...
        if (prefs31.getString("checked97bdf","no97bdf").equals("yes97bdf")){
        ...
        if (prefs32.getString("checked98bdf","no98bdf").equals("yes98bdf")){
        ...
        if (prefs33.getString("checked999bdf","no999bdf").equals("yes999bdf")){
