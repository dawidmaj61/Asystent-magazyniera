...
public class sregal218 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sregal218);
        ...
        switch_button.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor.putString("checked67ad","yes67ad");
                    prefEditor.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor.putString("checked67ad","false67ad");
                    prefEditor.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button2.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor2.putString("checked68ad","yes68ad");
                    prefEditor2.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView2.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor2.putString("checked68ad","false68ad");
                    prefEditor2.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button3.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor3.putString("checked86ad","yes86ad");
                    prefEditor3.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView3.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor3.putString("checked86ad","false86ad");
                    prefEditor3.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button4.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor4.putString("checked69ad","yes69ad");
                    prefEditor4.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView4.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor4.putString("checked69ad","false69ad");
                    prefEditor4.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button5.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor5.putString("checked70ad","yes70ad");
                    prefEditor5.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView5.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor5.putString("checked70ad","false70ad");
                    prefEditor5.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button6.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor6.putString("checked71ad","yes71ad");
                    prefEditor6.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView6.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor6.putString("checked71ad","false71ad");
                    prefEditor6.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button7.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor7.putString("checked72ad","yes72ad");
                    prefEditor7.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView7.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor7.putString("checked72ad","false72ad");
                    prefEditor7.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button8.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor8.putString("checked73ad","yes73ad");
                    prefEditor8.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView8.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor8.putString("checked73ad","false73ad");
                    prefEditor8.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button9.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor9.putString("checked74ad","yes74ad");
                    prefEditor9.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView9.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor9.putString("checked74ad","false74ad");
                    prefEditor9.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button10.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor10.putString("checked75ad","yes75ad");
                    prefEditor10.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView10.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor10.putString("checked75ad","false75ad");
                    prefEditor10.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button11.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor11.putString("checked76ad","yes76ad");
                    prefEditor11.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView11.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor11.putString("checked76ad","false76ad");
                    prefEditor11.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button12.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor12.putString("checked77ad","yes77ad");
                    prefEditor12.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView12.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor12.putString("checked77ad","false77ad");
                    prefEditor12.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button13.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor13.putString("checked78ad","yes78ad");
                    prefEditor13.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView13.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor13.putString("checked78ad","false78ad");
                    prefEditor13.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button14.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor14.putString("checked79ad","yes79ad");
                    prefEditor14.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView14.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor14.putString("checked79ad","false79ad");
                    prefEditor14.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button15.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor15.putString("checked80ad","yes80ad");
                    prefEditor15.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView15.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor15.putString("checked80ad","false80ad");
                    prefEditor15.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button16.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor16.putString("checked81ad","yes81ad");
                    prefEditor16.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView16.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor16.putString("checked81ad","false81ad");
                    prefEditor16.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button17.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor17.putString("checked82ad","yes82ad");
                    prefEditor17.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView17.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor17.putString("checked82ad","false82ad");
                    prefEditor17.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button18.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor18.putString("checked83ad","yes83ad");
                    prefEditor18.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView18.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor18.putString("checked83ad","false83ad");
                    prefEditor18.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button19.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor19.putString("checked84ad","yes84ad");
                    prefEditor19.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView19.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor19.putString("checked84ad","false84ad");
                    prefEditor19.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button20.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor20.putString("checked85ad","yes85ad");
                    prefEditor20.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView20.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor20.putString("checked85ad","false85ad");
                    prefEditor20.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button21.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor21.putString("checked87ad","yes87ad");
                    prefEditor21.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView21.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor21.putString("checked87ad","false87ad");
                    prefEditor21.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button22.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor22.putString("checked88ad","yes88ad");
                    prefEditor22.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView22.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor22.putString("checked88ad","false88ad");
                    prefEditor22.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button23.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor23.putString("checked89ad","yes89ad");
                    prefEditor23.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView23.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor23.putString("checked89ad","false89ad");
                    prefEditor23.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button24.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor24.putString("checked90ad","yes90ad");
                    prefEditor24.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView24.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor24.putString("checked90ad","false90ad");
                    prefEditor24.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button25.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor25.putString("checked91ad","yes91ad");
                    prefEditor25.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView25.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor25.putString("checked91ad","false91ad");
                    prefEditor25.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button26.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor26.putString("checked92ad","yes92ad");
                    prefEditor26.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView26.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor26.putString("checked92ad","false92ad");
                    prefEditor26.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button27.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor27.putString("checked93ad","yes93ad");
                    prefEditor27.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView27.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor27.putString("checked93ad","false93ad");
                    prefEditor27.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button28.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor28.putString("checked94ad","yes94ad");
                    prefEditor28.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView28.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor28.putString("checked94ad","false94ad");
                    prefEditor28.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button29.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor29.putString("checked95ad","yes95ad");
                    prefEditor29.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView29.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor29.putString("checked95ad","false95ad");
                    prefEditor29.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button30.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor30.putString("checked96ad","yes96ad");
                    prefEditor30.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView30.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor30.putString("checked96ad","false96ad");
                    prefEditor30.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button31.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor31.putString("checked97ad","yes97ad");
                    prefEditor31.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView31.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor31.putString("checked97ad","false97ad");
                    prefEditor31.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button32.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked98ad","yes98ad");
                    prefEditor32.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView32.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked98ad","false98ad");
                    prefEditor32.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button33.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal218.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor33.putString("checked99ad","yes99ad");
                    prefEditor33.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView33.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal218.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked99ad","false99ad");
                    prefEditor33.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        if (prefs.getString("checked67ad","no67ad").equals("yes67ad")){
        ...
        if (prefs2.getString("checked68ad","no68ad").equals("yes68ad")){
        ...
        if (prefs3.getString("checked86ad","no86ad").equals("yes86ad")){
        ...
        if (prefs4.getString("checked69ad","no69ad").equals("yes69ad")){
        ...
        if (prefs5.getString("checked70ad","no70ad").equals("yes70ad")){
        ...
        if (prefs6.getString("checked83ad","no83ad").equals("yes83ad")){
        ...
        if (prefs7.getString("checked71ad","no71ad").equals("yes71ad")){
        ...
        if (prefs8.getString("checked72ad","no72ad").equals("yes72ad")){
        ...
        if (prefs9.getString("checked73ad","no73ad").equals("yes73ad")){
        ...
        if (prefs10.getString("checked74ad","no74ad").equals("yes74ad")){
        ...
        if (prefs11.getString("checked75ad","no75ad").equals("yes75ad")){
        ...
        if (prefs12.getString("checked76ad","no76ad").equals("yes76ad")){
        ...
        if (prefs13.getString("checked77ad","no77ad").equals("yes77ad")){
        ...
        if (prefs14.getString("checked78ad","no78ad").equals("yes78ad")){
        ...
        if (prefs15.getString("checked79ad","no79ad").equals("yes79ad")){
        ...
        if (prefs16.getString("checked80ad","no80ad").equals("yes80ad")){
        ...
        if (prefs17.getString("checked81ad","no81ad").equals("yes81ad")){
        ...
        if (prefs18.getString("checked82ad","no82ad").equals("yes82ad")){
        ...
        if (prefs19.getString("checked84ad","no84ad").equals("yes84ad")){
        ...
        if (prefs20.getString("checked85ad","no85ad").equals("yes85ad")){
        ...
        if (prefs21.getString("checked87ad","no87ad").equals("yes87ad")){
        ...
        if (prefs22.getString("checked88ad","no88ad").equals("yes88ad")){
        ...
        if (prefs23.getString("checked89ad","no89ad").equals("yes89ad")){
        ...
        if (prefs24.getString("checked90ad","no90ad").equals("yes90ad")){
        ...
        if (prefs25.getString("checked91ad","no91ad").equals("yes91ad")){
        ...
        if (prefs26.getString("checked92ad","no92ad").equals("yes92ad")){
        ...
        if (prefs27.getString("checked93ad","no93ad").equals("yes93ad")){
        ...
        if (prefs28.getString("checked94ad","no94ad").equals("yes94ad")){
        ...
        if (prefs29.getString("checked95ad","no95ad").equals("yes95ad")){
        ...
        if (prefs30.getString("checked96ad","no96ad").equals("yes96ad")){
        ...
        if (prefs31.getString("checked97ad","no97ad").equals("yes97ad")){
        ...
        if (prefs32.getString("checked98ad","no98ad").equals("yes98ad")){
        ...
        if (prefs33.getString("checked99ad","no99ad").equals("yes99ad")){
        ...
        pass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor16.putInt("lastScore16",score);
                editor16.apply();
