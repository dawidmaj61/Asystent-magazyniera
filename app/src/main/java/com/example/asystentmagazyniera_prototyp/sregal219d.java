...
public class sregal219d extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch_button.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor.putString("checked1df","yes1df");
                    prefEditor.apply();
                }else{
                    imageView.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor.putString("checked1df","false1df");
                    prefEditor.apply();
                }
            }
        });
        switch_button2.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor2.putString("checked2df","yes2df");
                    prefEditor2.apply();
                }else{
                    imageView2.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor2.putString("checked2df","false2df");
                    prefEditor2.apply();
                }
            }
        });
        switch_button3.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor3.putString("checked3df","yes3df");
                    prefEditor3.apply();
                }else{
                    imageView3.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor3.putString("checked3df","false3df");
                    prefEditor3.apply();
                }
            }
        });
        switch_button4.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor4.putString("checked4df","yes4df");
                    prefEditor4.apply();
                }else{
                    imageView4.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor4.putString("checked4df","false4df");
                    prefEditor4.apply();
                }
            }
        });
        switch_button5.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor5.putString("checked5df","yes5df");
                    prefEditor5.apply();
                }else{
                    imageView5.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor5.putString("checked5df","false5df");
                    prefEditor5.apply();
                }
            }
        });
        switch_button6.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor6.putString("checked6df","yes6df");
                    prefEditor6.apply();
                }else{
                    imageView6.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor6.putString("checked6df","false6df");
                    prefEditor6.apply();
                }
            }
        });
        switch_button7.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor7.putString("checked7df","yes7df");
                    prefEditor7.apply();
                }else{
                    imageView7.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor7.putString("checked7df","false7df");
                    prefEditor7.apply();
                }
            }
        });
        switch_button8.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor8.putString("checked8df","yes8df");
                    prefEditor8.apply();
                }else{
                    imageView8.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor8.putString("checked8df","false8df");
                    prefEditor8.apply();
                }
            }
        });
        switch_button9.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor9.putString("checked9df","yes9df");
                    prefEditor9.apply();
                }else{
                    imageView9.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor9.putString("checked9df","false9df");
                    prefEditor9.apply();
                }
            }
        });
        switch_button10.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor10.putString("checked10df","yes10df");
                    prefEditor10.apply();
                }else{
                    imageView10.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor10.putString("checked10df","false10df");
                    prefEditor10.apply();
                }
            }
        });
        switch_button11.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor11.putString("checked11df","yes11df");
                    prefEditor11.apply();
                }else{
                    imageView11.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor11.putString("checked11df","false11df");
                    prefEditor11.apply();
                }
            }
        });
        switch_button12.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor12.putString("checked12df","yes12df");
                    prefEditor12.apply();
                }else{
                    imageView12.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor12.putString("checked12df","false12df");
                    prefEditor12.apply();
                }
            }
        });
        switch_button13.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor13.putString("checked13df","yes13df");
                    prefEditor13.apply();
                }else{
                    imageView13.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor13.putString("checked13df","false13df");
                    prefEditor13.apply();
                }
            }
        });
        switch_button14.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor14.putString("checked14df","yes14df");
                    prefEditor14.apply();
                }else{
                    imageView14.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor14.putString("checked14df","false14df");
                    prefEditor14.apply();
                }
            }
        });
        switch_button15.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor15.putString("checked15df","yes15df");
                    prefEditor15.apply();
                }else{
                    imageView15.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor15.putString("checked15df","false15df");
                    prefEditor15.apply();
                }
            }
        });
        switch_button16.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor16.putString("checked16df","yes16df");
                    prefEditor16.apply();
                }else{
                    imageView16.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor16.putString("checked16df","false16df");
                    prefEditor16.apply();
                }
            }
        });
        switch_button17.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor17.putString("checked17df","yes17df");
                    prefEditor17.apply();
                }else{
                    imageView17.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor17.putString("checked17df","false17df");
                    prefEditor17.apply();
                }
            }
        });
        switch_button18.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor18.putString("checked18df","yes18df");
                    prefEditor18.apply();
                }else{
                    imageView18.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor18.putString("checked18df","false18df");
                    prefEditor18.apply();
                }
            }
        });
        switch_button19.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor19.putString("checked19df","yes19df");
                    prefEditor19.apply();
                }else{
                    imageView19.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor19.putString("checked19df","false19df");
                    prefEditor19.apply();
                }
            }
        });
        switch_button20.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor20.putString("checked20df","yes20df");
                    prefEditor20.apply();
                }else{
                    imageView20.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor20.putString("checked20df","false20df");
                    prefEditor20.apply();
                }
            }
        });
        switch_button21.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor21.putString("checked21df","yes21df");
                    prefEditor21.apply();
                }else{
                    imageView21.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor21.putString("checked21df","false21df");
                    prefEditor21.apply();
                }
            }
        });
        switch_button22.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor22.putString("checked22df","yes22df");
                    prefEditor22.apply();
                }else{
                    imageView22.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor22.putString("checked22df","false22df");
                    prefEditor22.apply();
                }
            }
        });
        switch_button23.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor23.putString("checked23df","yes23df");
                    prefEditor23.apply();
                }else{
                    imageView23.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor23.putString("checked23df","false23df");
                    prefEditor23.apply();
                }
            }
        });
        switch_button24.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor24.putString("checked24df","yes24df");
                    prefEditor24.apply();
                }else{
                    imageView24.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor24.putString("checked24df","false24df");
                    prefEditor24.apply();
                }
            }
        });
        switch_button25.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor25.putString("checked25df","yes25df");
                    prefEditor25.apply();
                }else{
                    imageView25.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor25.putString("checked25df","false25df");
                    prefEditor25.apply();
                }
            }
        });
        switch_button26.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor26.putString("checked26df","yes26df");
                    prefEditor26.apply();
                }else{
                    imageView26.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor26.putString("checked26df","false26df");
                    prefEditor26.apply();
                }
            }
        });
        switch_button27.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor27.putString("checked27df","yes27df");
                    prefEditor27.apply();
                }else{
                    imageView27.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor27.putString("checked27df","false27df");
                    prefEditor27.apply();
                }
            }
        });
        switch_button28.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor28.putString("checked28df","yes28df");
                    prefEditor28.apply();
                }else{
                    imageView28.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor28.putString("checked28df","false28df");
                    prefEditor28.apply();
                }
            }
        });
        switch_button29.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor29.putString("checked29df","yes29df");
                    prefEditor29.apply();
                }else{
                    imageView29.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor29.putString("checked29df","false29df");
                    prefEditor29.apply();
                }
            }
        });
        switch_button30.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor30.putString("checked30df","yes30df");
                    prefEditor30.apply();
                }else{
                    imageView30.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor30.putString("checked30df","false30df");
                    prefEditor30.apply();
                }
            }
        });
        switch_button31.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor31.putString("checked31df","yes31df");
                    prefEditor31.apply();
                }else{
                    imageView31.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor31.putString("checked31df","false31df");
                    prefEditor31.apply();
                }
            }
        });
        switch_button32.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked32df","yes32df");
                    prefEditor32.apply();
                }else{
                    imageView32.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked32df","false32df");
                    prefEditor32.apply();
                }
            }
        });
        switch_button33.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219d.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor33.putString("checked33df","yes33df");
                    prefEditor33.apply();
                }else{
                    imageView33.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219d.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked33df","false33df");
                    prefEditor33.apply();
                }
            }
        });
        ...
        if (prefs.getString("checked1df","no1df").equals("yes1df")){
        ...
        if (prefs2.getString("checked2df","no2df").equals("yes2df")){
        ...
        if (prefs3.getString("checked3df","no3df").equals("yes3df")){
        ...
        if (prefs4.getString("checked4df","no4df").equals("yes4df")){
        ...
        if (prefs5.getString("checked5df","no5df").equals("yes5df")){
        ...
        if (prefs6.getString("checked6df","no6df").equals("yes6df")){
        ...
        if (prefs7.getString("checked7df","no7df").equals("yes7df")){
        ...
        if (prefs8.getString("checked8df","no8df").equals("yes8df")){
        ...
        if (prefs9.getString("checked9df","no9df").equals("yes9df")){
        ...
        if (prefs10.getString("checked10df","no10df").equals("yes10df")){
        ...
        if (prefs11.getString("checked11df","no11df").equals("yes11df")){
        ...
        if (prefs12.getString("checked12df","no12df").equals("yes12df")){
        ...
        if (prefs13.getString("checked13df","no13df").equals("yes13df")){
        ...
        if (prefs14.getString("checked14df","no14df").equals("yes14df")){
        ...
        if (prefs15.getString("checked15df","no15df").equals("yes15df")){
        ...
        if (prefs16.getString("checked16df","no16df").equals("yes16df")){
        ...
        if (prefs17.getString("checked17df","no17df").equals("yes17df")){
        ...
        if (prefs18.getString("checked18df","no18df").equals("yes18df")){
        ...
        if (prefs19.getString("checked19df","no19df").equals("yes19df")){
        ...
        if (prefs20.getString("checked20df","no20df").equals("yes20df")){
        ...
        if (prefs21.getString("checked21df","no21df").equals("yes21df")){
        ...
        if (prefs22.getString("checked22df","no22df").equals("yes22df")){
        ...
        if (prefs23.getString("checked23df","no23df").equals("yes23df")){
        ...
        if (prefs24.getString("checked24df","no24df").equals("yes24df")){
        ...
        if (prefs25.getString("checked25df","no25df").equals("yes25df")){
        ...
        if (prefs26.getString("checked26df","no26df").equals("yes26df")){
        ...
        if (prefs27.getString("checked27df","no27df").equals("yes27df")){
        ...
        if (prefs28.getString("checked28df","no28df").equals("yes28df")){
        ...
        if (prefs29.getString("checked29df","no29df").equals("yes29df")){
        ...
        if (prefs30.getString("checked30df","no30df").equals("yes30df")){
        ...
        if (prefs31.getString("checked31df","no31df").equals("yes31df")){
        ...
        if (prefs32.getString("checked32df","no32df").equals("yes32df")){
        ...
        if (prefs33.getString("checked33df","no33df").equals("yes33df")){
