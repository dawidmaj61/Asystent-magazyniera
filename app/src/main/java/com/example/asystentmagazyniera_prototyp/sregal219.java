...
public class sregal219 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sregal219);
        ...
        switch_button.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor.putString("checked1d","yes1d");
                    prefEditor.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor.putString("checked1d","false1d");
                    prefEditor.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button2.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor2.putString("checked2d","yes2d");
                    prefEditor2.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView2.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor2.putString("checked2d","false2d");
                    prefEditor2.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button3.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor3.putString("checked3d","yes3d");
                    prefEditor3.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView3.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor3.putString("checked3d","false3d");
                    prefEditor3.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button4.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor4.putString("checked4d","yes4d");
                    prefEditor4.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView4.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor4.putString("checked4d","false4d");
                    prefEditor4.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button5.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor5.putString("checked5d","yes5d");
                    prefEditor5.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView5.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor5.putString("checked5d","false5d");
                    prefEditor5.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button6.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor6.putString("checked6d","yes6d");
                    prefEditor6.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView6.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor6.putString("checked6d","false6d");
                    prefEditor6.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button7.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor7.putString("checked7d","yes7d");
                    prefEditor7.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView7.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor7.putString("checked7d","false7d");
                    prefEditor7.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button8.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor8.putString("checked8d","yes8d");
                    prefEditor8.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView8.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor8.putString("checked8d","false8d");
                    prefEditor8.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button9.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor9.putString("checked9d","yes9d");
                    prefEditor9.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView9.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor9.putString("checked9d","false9d");
                    prefEditor9.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button10.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor10.putString("checked10d","yes10d");
                    prefEditor10.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView10.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor10.putString("checked10d","false10d");
                    prefEditor10.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button11.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor11.putString("checked11d","yes11d");
                    prefEditor11.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView11.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor11.putString("checked11d","false11d");
                    prefEditor11.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button12.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor12.putString("checked12d","yes12d");
                    prefEditor12.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView12.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor12.putString("checked12d","false12d");
                    prefEditor12.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button13.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor13.putString("checked13d","yes13d");
                    prefEditor13.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView13.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor13.putString("checked13d","false13d");
                    prefEditor13.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button14.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor14.putString("checked14d","yes14d");
                    prefEditor14.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView14.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor14.putString("checked14d","false14d");
                    prefEditor14.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button15.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor15.putString("checked15d","yes15d");
                    prefEditor15.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView15.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor15.putString("checked15d","false15d");
                    prefEditor15.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button16.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor16.putString("checked16d","yes16d");
                    prefEditor16.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView16.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor16.putString("checked16d","false16d");
                    prefEditor16.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button17.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor17.putString("checked17d","yes17d");
                    prefEditor17.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView17.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor17.putString("checked17d","false17d");
                    prefEditor17.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button18.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor18.putString("checked18d","yes18d");
                    prefEditor18.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView18.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor18.putString("checked18d","false18d");
                    prefEditor18.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button19.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor19.putString("checked19d","yes19d");
                    prefEditor19.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView19.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor19.putString("checked19d","false19d");
                    prefEditor19.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button20.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor20.putString("checked20d","yes20d");
                    prefEditor20.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView20.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor20.putString("checked20d","false20d");
                    prefEditor20.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button21.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor21.putString("checked21d","yes21d");
                    prefEditor21.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView21.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor21.putString("checked21d","false21d");
                    prefEditor21.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button22.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor22.putString("checked22d","yes22d");
                    prefEditor22.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView22.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor22.putString("checked22d","false22d");
                    prefEditor22.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button23.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor23.putString("checked23d","yes23d");
                    prefEditor23.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView23.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor23.putString("checked23d","false23d");
                    prefEditor23.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button24.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor24.putString("checked24d","yes24d");
                    prefEditor24.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView24.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor24.putString("checked24d","false24d");
                    prefEditor24.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button25.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor25.putString("checked25d","yes25d");
                    prefEditor25.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView25.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor25.putString("checked25d","false25d");
                    prefEditor25.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button26.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor26.putString("checked26d","yes26d");
                    prefEditor26.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView26.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor26.putString("checked26d","false26d");
                    prefEditor26.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button27.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor27.putString("checked27d","yes27d");
                    prefEditor27.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView27.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor27.putString("checked27d","false27d");
                    prefEditor27.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button28.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor28.putString("checked28d","yes28d");
                    prefEditor28.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView28.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor28.putString("checked28d","false28d");
                    prefEditor28.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button29.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor29.putString("checked29d","yes29d");
                    prefEditor29.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView29.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor29.putString("checked29d","false29d");
                    prefEditor29.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button30.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor30.putString("checked30d","yes30d");
                    prefEditor30.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView30.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor30.putString("checked30d","false30d");
                    prefEditor30.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button31.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor31.putString("checked31d","yes31d");
                    prefEditor31.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView31.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor31.putString("checked31d","false31d");
                    prefEditor31.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button32.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked32d","yes32d");
                    prefEditor32.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView32.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked32d","false32d");
                    prefEditor32.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button33.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal219.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor33.putString("checked33d","yes33d");
                    prefEditor33.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView33.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal219.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked33d","false33d");
                    prefEditor33.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        if (prefs.getString("checked1d","no1d").equals("yes1d")){
        ...
        if (prefs2.getString("checked2d","no2d").equals("yes2d")){
        ...
        if (prefs3.getString("checked3d","no3d").equals("yes3d")){
        ...
        if (prefs4.getString("checked4d","no4d").equals("yes4d")){
        ...
        if (prefs5.getString("checked5d","no5d").equals("yes5d")){
        ...
        if (prefs6.getString("checked6d","no6d").equals("yes6d")){
        ...
        if (prefs7.getString("checked7d","no7d").equals("yes7d")){
        ...
        if (prefs8.getString("checked8d","no8d").equals("yes8d")){
        ...
        if (prefs9.getString("checked9d","no9d").equals("yes9d")){
        ...
        if (prefs10.getString("checked10d","no10d").equals("yes10d")){
        ...
        if (prefs11.getString("checked11d","no11d").equals("yes11d")){
        ...
        if (prefs12.getString("checked12d","no12d").equals("yes12d")){
        ...
        if (prefs13.getString("checked13d","no13d").equals("yes13d")){
        ...
        if (prefs14.getString("checked14d","no14d").equals("yes14d")){
        ...
        if (prefs15.getString("checked15d","no15d").equals("yes15d")){
        ...
        if (prefs16.getString("checked16d","no16d").equals("yes16d")){
        ...
        if (prefs17.getString("checked17d","no17d").equals("yes17d")){
        ...
        if (prefs18.getString("checked18d","no18d").equals("yes18d")){
        ...
        if (prefs19.getString("checked19d","no19d").equals("yes19d")){
        ...
        if (prefs20.getString("checked20d","no20d").equals("yes20d")){
        ...
        if (prefs21.getString("checked21d","no21d").equals("yes21d")){
        ...
        if (prefs22.getString("checked22d","no22d").equals("yes22d")){
        ...
        if (prefs23.getString("checked23d","no23d").equals("yes23d")){
        ...
        if (prefs24.getString("checked24d","no24d").equals("yes24d")){
        ...
        if (prefs25.getString("checked25d","no25d").equals("yes25d")){
        ...
        if (prefs26.getString("checked26d","no26d").equals("yes26d")){
        ...
        if (prefs27.getString("checked27d","no27d").equals("yes27d")){
        ...
        if (prefs28.getString("checked28d","no28d").equals("yes28d")){
        ...
        if (prefs29.getString("checked29d","no29d").equals("yes29d")){
        ...
        if (prefs30.getString("checked30d","no30d").equals("yes30d")){
        ...
        if (prefs31.getString("checked31d","no31d").equals("yes31d")){
        ...
        if (prefs32.getString("checked32d","no32d").equals("yes32d")){
        ...
        if (prefs33.getString("checked33d","no33d").equals("yes33d")){
        ...
        pass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor17.putInt("lastScore17",score);
                editor17.apply();
