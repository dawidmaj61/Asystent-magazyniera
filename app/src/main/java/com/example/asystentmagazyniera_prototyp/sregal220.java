...
public class sregal220 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sregal220);
        ...
        switch_button.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor.putString("checked34bd","yes34bd");
                    prefEditor.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor.putString("checked34bd","false34bd");
                    prefEditor.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button2.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor2.putString("checked35bd","yes35bd");
                    prefEditor2.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView2.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor2.putString("checked35bd","false35bd");
                    prefEditor2.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button3.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor3.putString("checked36bd","yes36bd");
                    prefEditor3.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView3.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor3.putString("checked36bd","false36bd");
                    prefEditor3.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button4.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor4.putString("checked37bd","yes37bd");
                    prefEditor4.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView4.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor4.putString("checked37bd","false37bd");
                    prefEditor4.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button5.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor5.putString("checked38bd","yes38bd");
                    prefEditor5.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView5.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor5.putString("checked38bd","false38bd");
                    prefEditor5.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button6.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor6.putString("checked39bd","yes39bd");
                    prefEditor6.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView6.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor6.putString("checked39bd","false39bd");
                    prefEditor6.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button7.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor7.putString("checked40bd","yes40bd");
                    prefEditor7.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView7.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor7.putString("checked40bd","false40bd");
                    prefEditor7.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button8.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor8.putString("checked41bd","yes41bd");
                    prefEditor8.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView8.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor8.putString("checked41bd","false41bd");
                    prefEditor8.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button9.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor9.putString("checked42bd","yes42bd");
                    prefEditor9.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView9.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor9.putString("checked42bd","false42bd");
                    prefEditor9.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button10.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor10.putString("checked43bd","yes43bd");
                    prefEditor10.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView10.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor10.putString("checked43bd","false43bd");
                    prefEditor10.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button11.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor11.putString("checked44bd","yes44bd");
                    prefEditor11.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView11.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor11.putString("checked44bd","false44bd");
                    prefEditor11.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button12.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor12.putString("checked45bd","yes45bd");
                    prefEditor12.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView12.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor12.putString("checked45bd","false45bd");
                    prefEditor12.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button13.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor13.putString("checked46bd","yes46bd");
                    prefEditor13.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView13.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor13.putString("checked46bd","false46bd");
                    prefEditor13.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button14.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor14.putString("checked47bd","yes47bd");
                    prefEditor14.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView14.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor14.putString("checked47bd","false47bd");
                    prefEditor14.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button15.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor15.putString("checked48bd","yes48bd");
                    prefEditor15.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView15.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor15.putString("checked48bd","false48bd");
                    prefEditor15.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button16.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor16.putString("checked49bd","yes49bd");
                    prefEditor16.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView16.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor16.putString("checked49bd","false49bd");
                    prefEditor16.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button17.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor17.putString("checked50bd","yes50bd");
                    prefEditor17.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView17.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor17.putString("checked50bd","false50bd");
                    prefEditor17.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button18.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor18.putString("checked51bd","yes51bd");
                    prefEditor18.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView18.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor18.putString("checked51bd","false51bd");
                    prefEditor18.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button19.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor19.putString("checked52bd","yes52bd");
                    prefEditor19.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView19.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor19.putString("checked52bd","false52bd");
                    prefEditor19.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button20.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor20.putString("checked53bd","yes53bd");
                    prefEditor20.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView20.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor20.putString("checked53bd","false53bd");
                    prefEditor20.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button21.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor21.putString("checked54bd","yes54bd");
                    prefEditor21.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView21.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor21.putString("checked54bd","false54bd");
                    prefEditor21.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button22.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor22.putString("checked55bd","yes55bd");
                    prefEditor22.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView22.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor22.putString("checked55bd","false55bd");
                    prefEditor22.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button23.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor23.putString("checked56bd","yes56bd");
                    prefEditor23.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView23.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor23.putString("checked56bd","false56bd");
                    prefEditor23.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button24.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor24.putString("checked57bd","yes57bd");
                    prefEditor24.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView24.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor24.putString("checked57bd","false57bd");
                    prefEditor24.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button25.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor25.putString("checked58bd","yes58bd");
                    prefEditor25.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView25.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor25.putString("checked58bd","false58bd");
                    prefEditor25.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button26.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor26.putString("checked59bd","yes59bd");
                    prefEditor26.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView26.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor26.putString("checked59bd","false59bd");
                    prefEditor26.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button27.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor27.putString("checked60bd","yes60bd");
                    prefEditor27.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView27.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor27.putString("checked60bd","false60bd");
                    prefEditor27.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button28.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor28.putString("checked61bd","yes61bd");
                    prefEditor28.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView28.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor28.putString("checked61bd","false61bd");
                    prefEditor28.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button29.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor29.putString("checked62bd","yes62bd");
                    prefEditor29.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView29.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor29.putString("checked62bd","false62bd");
                    prefEditor29.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button30.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor30.putString("checked63bd","yes63bd");
                    prefEditor30.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView30.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor30.putString("checked63bd","false63bd");
                    prefEditor30.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button31.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor31.putString("checked64bd","yes64bd");
                    prefEditor31.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView31.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor31.putString("checked64bd","false64bd");
                    prefEditor31.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button32.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked65bd","yes65bd");
                    prefEditor32.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView32.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked65bd","false65bd");
                    prefEditor32.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button33.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal220.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor33.putString("checked66bd","yes66bd");
                    prefEditor33.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView33.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal220.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked66bd","false66bd");
                    prefEditor33.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        if (prefs.getString("checked34bd","no34bd").equals("yes34bd")){
        ...
        if (prefs2.getString("checked35bd","no35bd").equals("yes35bd")){
        ...
        if (prefs3.getString("checked36bd","no36bd").equals("yes36bd")){
        ...
        if (prefs4.getString("checked37bd","no37bd").equals("yes37bd")){
        ...
        if (prefs5.getString("checked38bd","no38bd").equals("yes38bd")){
        ...
        if (prefs6.getString("checked39bd","no39bd").equals("yes39bd")){
        ...
        if (prefs7.getString("checked40bd","no40bd").equals("yes40bd")){
        ...
        if (prefs8.getString("checked41bd","no41bd").equals("yes41bd")){
        ...
        if (prefs9.getString("checked42bd","no42bd").equals("yes42bd")){
        ...
        if (prefs10.getString("checked43bd","no43bd").equals("yes43bd")){
        ...
        if (prefs11.getString("checked44bd","no44bd").equals("yes44bd")){
        ...
        if (prefs12.getString("checked45bd","no45bd").equals("yes45bd")){
        ...
        if (prefs13.getString("checked46bd","no46bd").equals("yes46bd")){
        ...
        if (prefs14.getString("checked47bd","no47bd").equals("yes47bd")){
        ...
        if (prefs15.getString("checked48bd","no48bd").equals("yes48bd")){
        ...
        if (prefs16.getString("checked49bd","no49bd").equals("yes49bd")){
        ...
        if (prefs17.getString("checked50bd","no50bd").equals("yes50bd")){
        ...
        if (prefs18.getString("checked51bd","no51bd").equals("yes51bd")){
        ...
        if (prefs19.getString("checked52bd","no52bd").equals("yes52bd")){
        ...
        if (prefs20.getString("checked53bd","no53bd").equals("yes53bd")){
        ...
        if (prefs21.getString("checked54bd","no54bd").equals("yes54bd")){
        ...
        if (prefs22.getString("checked55bd","no55bd").equals("yes55bd")){
        ...
        if (prefs23.getString("checked56bd","no56bd").equals("yes56bd")){
        ...
        if (prefs24.getString("checked57bd","no57bd").equals("yes57bd")){
        ...
        if (prefs25.getString("checked58bd","no58bd").equals("yes58bd")){
        ...
        if (prefs26.getString("checked59bd","no59bd").equals("yes59bd")){
        ...
        if (prefs27.getString("checked60bd","no60bd").equals("yes60bd")){
        ...
        if (prefs28.getString("checked61bd","no61bd").equals("yes61bd")){
        ...
        if (prefs29.getString("checked62bd","no62bd").equals("yes62bd")){
        ...
        if (prefs30.getString("checked63bd","no63bd").equals("yes63bd")){
        ...
        if (prefs31.getString("checked64bd","no64bd").equals("yes64bd")){
        ...
        if (prefs32.getString("checked65bd","no65bd").equals("yes65bd")){
        ...
        if (prefs33.getString("checked66bd","no66bd").equals("yes66bd")){
        ...
        pass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor18.putInt("lastScore18",score);
                editor18.apply();
