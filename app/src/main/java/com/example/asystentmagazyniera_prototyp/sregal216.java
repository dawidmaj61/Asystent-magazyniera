...
public class sregal216 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sregal216);
        ...
        switch_button.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor.putString("checked1ad","yes1ad");
                    prefEditor.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor.putString("checked1ad","false1ad");
                    prefEditor.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button2.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor2.putString("checked2ad","yes2ad");
                    prefEditor2.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView2.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor2.putString("checked2ad","false2ad");
                    prefEditor2.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button3.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor3.putString("checked3ad","yes3ad");
                    prefEditor3.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView3.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor3.putString("checked3ad","false3ad");
                    prefEditor3.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button4.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor4.putString("checked4ad","yes4ad");
                    prefEditor4.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView4.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor4.putString("checked4ad","false4ad");
                    prefEditor4.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button5.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor5.putString("checked5ad","yes5ad");
                    prefEditor5.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView5.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor5.putString("checked5ad","false5ad");
                    prefEditor5.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button6.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor6.putString("checked6ad","yes6ad");
                    prefEditor6.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView6.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor6.putString("checked6ad","false6ad");
                    prefEditor6.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button7.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor7.putString("checked7ad","yes7ad");
                    prefEditor7.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView7.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor7.putString("checked7ad","false7ad");
                    prefEditor7.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button8.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor8.putString("checked8ad","yes8ad");
                    prefEditor8.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView8.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor8.putString("checked8ad","false8ad");
                    prefEditor8.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button9.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor9.putString("checked9ad","yes9ad");
                    prefEditor9.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView9.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor9.putString("checked9ad","false9ad");
                    prefEditor9.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button10.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor10.putString("checked10ad","yes10ad");
                    prefEditor10.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView10.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor10.putString("checked10ad","false10ad");
                    prefEditor10.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button11.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor11.putString("checked11ad","yes11ad");
                    prefEditor11.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView11.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor11.putString("checked11ad","false11ad");
                    prefEditor11.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button12.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor12.putString("checked12ad","yes12ad");
                    prefEditor12.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView12.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor12.putString("checked12ad","false12ad");
                    prefEditor12.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button13.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor13.putString("checked13ad","yes13ad");
                    prefEditor13.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView13.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor13.putString("checked13ad","false13ad");
                    prefEditor13.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button14.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor14.putString("checked14ad","yes14ad");
                    prefEditor14.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView14.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor14.putString("checked14ad","false14ad");
                    prefEditor14.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button15.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor15.putString("checked15ad","yes15ad");
                    prefEditor15.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView15.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor15.putString("checked15ad","false15ad");
                    prefEditor15.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button16.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor16.putString("checked16ad","yes16ad");
                    prefEditor16.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView16.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor16.putString("checked16ad","false16ad");
                    prefEditor16.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button17.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor17.putString("checked17ad","yes17ad");
                    prefEditor17.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView17.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor17.putString("checked17ad","false17ad");
                    prefEditor17.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button18.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor18.putString("checked18ad","yes18ad");
                    prefEditor18.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView18.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor18.putString("checked18ad","false18ad");
                    prefEditor18.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button19.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor19.putString("checked19ad","yes19ad");
                    prefEditor19.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView19.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor19.putString("checked19ad","false19ad");
                    prefEditor19.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button20.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor20.putString("checked20ad","yes20ad");
                    prefEditor20.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView20.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor20.putString("checked20ad","false20ad");
                    prefEditor20.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button21.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor21.putString("checked21ad","yes21ad");
                    prefEditor21.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView21.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor21.putString("checked21ad","false21ad");
                    prefEditor21.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button22.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor22.putString("checked22ad","yes22ad");
                    prefEditor22.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView22.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor22.putString("checked22ad","false22ad");
                    prefEditor22.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button23.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor23.putString("checked23ad","yes23ad");
                    prefEditor23.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView23.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor23.putString("checked23ad","false23ad");
                    prefEditor23.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button24.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor24.putString("checked24ad","yes24ad");
                    prefEditor24.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView24.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor24.putString("checked24ad","false24ad");
                    prefEditor24.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button25.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor25.putString("checked25ad","yes25ad");
                    prefEditor25.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView25.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor25.putString("checked25ad","false25ad");
                    prefEditor25.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button26.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor26.putString("checked26ad","yes26ad");
                    prefEditor26.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView26.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor26.putString("checked26ad","false26ad");
                    prefEditor26.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button27.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor27.putString("checked27ad","yes27ad");
                    prefEditor27.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView27.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor27.putString("checked27ad","false27ad");
                    prefEditor27.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button28.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor28.putString("checked28ad","yes28ad");
                    prefEditor28.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView28.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor28.putString("checked28ad","false28ad");
                    prefEditor28.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button29.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor29.putString("checked29ad","yes29ad");
                    prefEditor29.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView29.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor29.putString("checked29ad","false29ad");
                    prefEditor29.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button30.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor30.putString("checked30ad","yes30ad");
                    prefEditor30.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView30.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor30.putString("checked30ad","false30ad");
                    prefEditor30.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button31.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor31.putString("checked31ad","yes31ad");
                    prefEditor31.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView31.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor31.putString("checked31ad","false31ad");
                    prefEditor31.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button32.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked32ad","yes32ad");
                    prefEditor32.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView32.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked32ad","false32ad");
                    prefEditor32.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        switch_button33.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(sregal216.this,"Zwolniono",Toast.LENGTH_SHORT).show();
                    prefEditor33.putString("checked33ad","yes33ad");
                    prefEditor33.apply();
                    score += 1;
                    showT.setText("Score: " + score);
                }else{
                    imageView33.setImageDrawable(getResources().getDrawable(R.drawable.button_off));
                    Toast.makeText(sregal216.this,"Zajęto",Toast.LENGTH_SHORT).show();
                    prefEditor32.putString("checked33ad","false33ad");
                    prefEditor33.apply();
                    score -= 1;
                    showT.setText("Score: " + score);
                }
        ...
        if (prefs.getString("checked1ad","no1ad").equals("yes1ad")){
        ...
        if (prefs2.getString("checked2ad","no2ad").equals("yes2ad")){
        ...
        if (prefs3.getString("checked3ad","no3ad").equals("yes3ad")){
        ...
        if (prefs4.getString("checked4ad","no4ad").equals("yes4ad")){
        ...
        if (prefs5.getString("checked5ad","no5ad").equals("yes5ad")){
        ...
        if (prefs6.getString("checked6ad","no6ad").equals("yes6ad")){
        ...
        if (prefs7.getString("checked7ad","no7ad").equals("yes7ad")){
        ...
        if (prefs8.getString("checked8ad","no8ad").equals("yes8ad")){
        ...
        if (prefs9.getString("checked9ad","no9ad").equals("yes9ad")){
        ...
        if (prefs10.getString("checked10ad","no10ad").equals("yes10ad")){
        ...
        if (prefs11.getString("checked11ad","no11ad").equals("yes11ad")){
        ...
        if (prefs12.getString("checked12ad","no12ad").equals("yes12ad")){
        ...
        if (prefs13.getString("checked13ad","no13ad").equals("yes13ad")){
        ...
        if (prefs14.getString("checked14ad","no14ad").equals("yes14ad")){
        ...
        if (prefs15.getString("checked15ad","no15ad").equals("yes15ad")){
        ...
        if (prefs16.getString("checked16ad","no16ad").equals("yes16ad")){
        ...
        if (prefs17.getString("checked17ad","no17ad").equals("yes17ad")){
        ...
        if (prefs18.getString("checked18ad","no18ad").equals("yes18ad")){
        ...
        if (prefs19.getString("checked19ad","no19ad").equals("yes19ad")){
        ...
        if (prefs20.getString("checked20ad","no20ad").equals("yes20ad")){
        ...
        if (prefs21.getString("checked21ad","no21ad").equals("yes21ad")){
        ...
        if (prefs22.getString("checked22ad","no22ad").equals("yes22ad")){
        ...
        if (prefs23.getString("checked23ad","no23ad").equals("yes23ad")){
        ...
        if (prefs24.getString("checked24ad","no24ad").equals("yes24ad")){
        ...
        if (prefs25.getString("checked25ad","no25ad").equals("yes25ad")){
        ...
        if (prefs26.getString("checked26ad","no26ad").equals("yes26ad")){
        ...
        if (prefs27.getString("checked27ad","no27ad").equals("yes27ad")){
        ...
        if (prefs28.getString("checked28ad","no28ad").equals("yes28ad")){
        ...
        if (prefs29.getString("checked29ad","no29ad").equals("yes29ad")){
        ...
        if (prefs30.getString("checked30ad","no30ad").equals("yes30ad")){
        ...
        if (prefs31.getString("checked31ad","no31ad").equals("yes31ad")){
        ...
        if (prefs32.getString("checked32ad","no32ad").equals("yes32ad")){
        ...
        if (prefs33.getString("checked33ad","no33ad").equals("yes33ad")){
        ...
        pass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor14.putInt("lastScore14",score);
                editor14.apply();
